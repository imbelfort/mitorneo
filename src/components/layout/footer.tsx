    ...
    return (
        <footer className="bg-white text-slate-600 py-12 border-t border-slate-200">
            <div className="container mx-auto px-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-3">
                            <a
                                ...
                                className="flex items-center gap-3 text-slate-500 hover:text-emerald-500 transition-colors group"
                            >
                                <div className="p-2 bg-slate-100 rounded-lg group-hover:bg-[#25D366] transition-colors duration-300">
                                    <svg
                                        viewBox="0 0 24 24"
                                        fill="currentColor"
                ...
                {/* Bottom Bar */}
                <div className="pt-8 border-t border-slate-200 flex flex-col-reverse md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
